...
EOF
    ...
    Canvas {
        ...
        function drawMountainWave(ctx, data, isShadow) {
            ...
            gradient.addColorStop(0.0, '{{ colors.primary.default.hex }}')
            gradient.addColorStop(0.3, '{{ colors.secondary.default.hex }}')
            gradient.addColorStop(0.6, '{{ colors.surface_tint.default.hex }}')
            gradient.addColorStop(1.0, '{{ colors.tertiary.default.hex }}')
